...
export const ArtworkContextArtistFragmentContainer = createFragmentContainer<{ artwork: ArtworkContextArtist_artwork }>(
  props => {
    return (
  ...
  {
    artwork: graphql`
      fragment ArtworkContextArtist_artwork on Artwork @argumentDefinitions(excludeArtworkIDs: { type: "[String!]" }) {
