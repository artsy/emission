...
export type ArtworkContextArtistTestsQueryVariables = {
    readonly excludeArtworkIds?: ReadonlyArray<string | null> | null;
};
export type ArtworkContextArtistTestsQueryResponse = {
    readonly artwork: ({
        readonly " $fragmentRefs": ArtworkContextArtist_artwork$ref;
    }) | null;
};
export type ArtworkContextArtistTestsQuery = {
    readonly response: ArtworkContextArtistTestsQueryResponse;
    readonly variables: ArtworkContextArtistTestsQueryVariables;
};



/*
query ArtworkContextArtistTestsQuery(
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "ArtworkContextArtistTestsQuery",
  "id": "794c5897ceac91e17f89e91abaeb0e9d",
  "text": null,
  "metadata": {},
  "fragment": {
    "kind": "Fragment",
...
(node as any).hash = '260f998e90def0188b619ca86b5ff2e5';
export default node;
