  ...
  renderSection(title: string, count: number, artworks: any[], stateQuery: any, onComplete: any){
    return (
      <View key={title}>
        ...
        <ArtworksGrid
          forSaleArtist={this.props.artist}
          notForSaleArtist={this.props.artist}
          artistSelector="forSaleArtist"
          selector="for_sale_artworks"
        />
      </View>
    )
  }
  ...
  fragments: {
    artist: () => Relay.QL`
      fragment on Artist {
        ...
        ${ArtworksGrid.getFragment('forSaleArtist')}
      }
    `,
  }
})
